...
MIMIC has changed the age of very old patients to 300.0011 to protect them. Here we are change it for 91.4 years
```{r}
...
You may find one or two sodium measures like 12.6 which clear means a typo and the actually value is 126, if the value is too unusual like potassium of 126, we deleted the measure.

# Data exploration

- data distribution in the variables ( have a look at the example below)
...
# Statistical analysis according to the variables distribution (Table 1)
...
## Unadjusted Statistical analysis of the deviation
...
### multiple linear regression wbc
...
### multiple linear regression platelets
...
### multiple linear regression sodium
...
### multiple linear regression potassium
...
### multiple linear regression log creatinine
...
### ultiple linear regression log BUN
...
### multiple linear regression BIC
...
# Creation of subset without any missing variable and analyzing the impact of the statistically significant deviations in the hospital mortality
